...
\begin{document}
	...
	The next step in this game will be making it so that more than 2 players can play at the same time. A further iteration of the software will have a dedicated Snake server that can run multiple games with lots of players concurrently.
	...
	\textbf{\makebox[4 cm]{Operation:\hfill}} server\_or\_client(boolean status)\\
	\textbf{\makebox[4 cm]{Cross References:\hfill}} UC1\\
